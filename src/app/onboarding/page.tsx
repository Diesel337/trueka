...
export default async function OnboardingPage({ searchParams }: OnboardingPageProps) {
  ...
  return (
    <main className="mx-auto grid w-full max-w-5xl flex-1 gap-6 px-4 py-6 sm:px-6 sm:py-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-8 lg:px-8">
      <section className="flex flex-col justify-center">
        ...
        <p className="mt-3 max-w-xl text-base leading-7 text-stone-600 sm:mt-4 sm:text-lg sm:leading-8">
          Tu zona e intereses ayudan a ordenar publicaciones y avisarte cuando aparezca algo que puede servirte.
        </p>
        <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 p-3 text-sm leading-6 text-emerald-950 sm:mt-6 sm:p-4">
